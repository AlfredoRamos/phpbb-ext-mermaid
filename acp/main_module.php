...
class main_module
{
	...
	/** @var \alfredoramos\mermaid\controller\acp */
	...
	public function __construct()
	{
		...
		$this->acp_controller = $phpbb_container->get('alfredoramos.mermaid.controller.acp');
	}
	...
	{
		// Load translations
		$this->language->add_lang(['acp/settings'], 'alfredoramos/mermaid');

		// Set form token
		add_form_key('alfredoramos_mermaid');

		switch ($mode)
		{
			case 'settings':
				$this->tpl_name = 'acp_mermaid_settings';
